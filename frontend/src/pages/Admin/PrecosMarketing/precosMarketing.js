...
export function PrecosMarketing() {
  const [dataPrecosmarketing, setdataPrecosmarketing] = useState([]);
  ...
  function updateItemArray(index, value) {
    let newArray = dataPrecosmarketing

    newArray[index].valor = value
    setdataPrecosmarketing(newArray)
  }
}
