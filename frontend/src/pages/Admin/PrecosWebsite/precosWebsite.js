...
export function PrecosWebsite() {
  const [dataPrecoswebsite, setdataPrecoswebsite] = useState([]);
  ...
  useEffect(() => {
    ...
    function updateItemArray(index, value) {
      let newArray = dataPrecoswebsite

      newArray[index].valor = value
      setdataPrecoswebsite(newArray)
    }
